...
public class MAIN {
    ...
    public void createFlights() {
        ...
        Flight flight = new Flight(flightNumber, origin, destination, departureTime, seats, price);
        flights.add(flight);
    ...
    public void TouristbookSeat(int flightNumber) {
        ...
        if (flag && (seats > 0)) {
            ...
            Places = sc.next();
            int IdCounter = 0;
            TouristTicket t = new TouristTicket(flights.get(index), IdCounter, price, Hotel_address, Places);
            TouristTickets.add(t);
            IdCounter++;
            System.out.println("you have successfully booked a seat for flight " + flightNumber);
